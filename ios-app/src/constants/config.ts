...
export const ROUTE_CONSTANTS = {
  ...
  // If nothing is found at chargerSearchRadiusKm, retry with these progressively
  // wider radii before giving up on the stop entirely.
  chargerSearchRadiusExpansionsKm: [40, 75, 120],
